...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="./../css/style buat artikel user.css" />
		<link
			rel="shortcut icon"
			href="./../src/img/favicon.ico"
			type="image/x-icon"
		/>
		<title>Meridio | Buat Artikel</title>
	</head>
	<body>
		<!-- Navigation Bar -->
		...
		<section class="bagian-tengah pb-4">
			<div class="container pt-5 mt-5">
				...
				<div class="row">
					<div class="col-md-12">
						<form acrion="" method="POST" class="mt-4" enctype="multipart/form-data">
                            ...
                            <?php if ($checkForm == 'bukan_foto'): ?>
                                <div class="form-group">
                                    <label for="headerArtikel">Masukkan Header Artikel</label>
                                    <input
                                        type="file"
                                        ...
                                        required
                                    />
                                    <small id="inputHeaderHelp" class="form-text text-muted">Size Maksimal Header 2MB</small>
                            ...
                            <?php endif?>
							<div class="form-group">
								<label for="ckedtor">Masukkan Isi Artikel</label>
        ...
        <script src="./../js/script buat artikel.js"></script>
